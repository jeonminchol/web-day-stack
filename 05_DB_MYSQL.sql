/*
    ...
    2. 논리적 모델링
      ...
      - 정규화 작업
    3. 물리적 모델링
       - 테이블 실질적으로 작성 (CREATE 문 작성)  --  이 이상으로 가면 역정규화 
    ...
    * 정규화(Nomalization)
    ...
    - 효율적인 자료 저장 및 데이터 무결성을 보장하고 오류를 최소화하여 안정성을
        ...
        제 3 정규화 : 속송에 종속적인 속성을 제거
*/               
/*
   사용자 or 사원 관련 정보 들어가는 데이터 하나 CREATE 문 작성해서 제출
   ...
   - 데이터 타입
     ...
     2. 숫자
       ...
       3. 날짜 및 시간
        ...
        4. 불리언
        - BOOLEAN / BOOL : 참(TRUE) 또는 거짓(FALSE) 값을 지정하는데 사용alter
           _ BLOB :  이진 데이터를 지정하는데 사용, 이미지나 동영상과 같은 이진 파일
                실제로는 이미지나 동영상은 따로 관리 (URL만 문자형으로 저장)
*/
CREATE TABLE USERS (
USER_ID INT AUTO_INCREMENT PRIMAR
USERNAME VARCHAR(50) NOT NULL,
EMAIL VARCHAR(100) UNIQUE,
PASSWORD VARCHAR(255) NOT NULL,
BIRTH_DATE DATE,
CREATED_AT DATETIME DEEFAULT TRUE
);
